        	...
        	<div class="container">
            	<div class="row">
                	<div class="col-sm-12">
                        ...
                        <p>Voici quelques réalisations, que ça soit pour le résidentiel, le commercial ou la restauration de maçonnerie</p>
                        <div class="breadcrumb-links">
                        	<a href="index.php">Accueil</a> <i class="fa fa-angle-double-right"></i> Nos réalisations
                        </div>
                    </div>
                </div>
            </div>
            	...
            	<div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                    	<div class="filter-wrap">
                            <div class="filter filter-btn" data-filter="all">Tous</div>
                            <div class="filter filter-btn" data-filter=".residentiel">Résidentiel</div>
                            <div class="filter filter-btn" data-filter=".commercial">Commercial</div>
                            <div class="filter filter-btn" data-filter=".restauration">Restauration</div>
                    ...
                    <div id="portfolio-container">
                        ...
                        <div class="mix residentiel col-sm-4">
                        	<div class="shadow-wrap">
                                <div class="item-thumbs">
                                    <a href="images/portfolio/img_1.jpg" class="fancybox hover-wrap" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet">
                        ...
                        <div class="mix residentiel col-sm-4">
                        	<div class="shadow-wrap">
                                <div class="item-thumbs">
                                    <a href="images/portfolio/img_4.jpg" class="fancybox hover-wrap" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet">
                                        <span class="overlay-img"></span>
                                        <span class="overlay-img-thumb"><i class="fa fa-plus"></i></span>                                        	
                                    </a>
                        ...
                        <div class="mix residentiel col-sm-4">
                        	<div class="shadow-wrap">
                                <div class="item-thumbs">
                                    <a href="images/portfolio/img_9.jpg" class="fancybox hover-wrap" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet">
                                        <span class="overlay-img"></span>
                                        <span class="overlay-img-thumb"><i class="fa fa-plus"></i></span>                                        	
                                    </a>
                        ...
                        <div class="mix residentiel col-sm-4">
                        	<div class="shadow-wrap">
                                <div class="item-thumbs">
                                    <a href="images/portfolio/img_12.jpg" class="fancybox hover-wrap" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet">
                                        <span class="overlay-img"></span>
                                        <span class="overlay-img-thumb"><i class="fa fa-plus"></i></span>                                        	
                                    </a>
